...
class Personaje:
    ...
    def __str__(self):
        return "{} => {} vida, {} ataque, {} defensa, {} alcance".format(self.nombre, self.vida, self.alcance, self.ataque, self.defensa)
...
# G.agregar(Personaje("Guerrera",2,4,2,4))
# G.agregar(Personaje("Arquera",2,4,1,8))
# G.mostrar()
G.borrar("Arquero")
G.borrar("Caballera")
G.mostrar()